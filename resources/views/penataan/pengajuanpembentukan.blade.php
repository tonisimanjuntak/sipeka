<form action="{{ url('penataan/simpan') }}" method="POST" id="formPengajuan" enctype="multipart/form-data">
    <meta name="csrf-token-pengajuan" content="{{ csrf_token() }}">
    <input type="hidden" name="jenispenataan" id="jenispenataan" value="{{ $jenispenataan }}">
    <div class="card">
