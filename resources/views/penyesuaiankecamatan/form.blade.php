...
@include('pembentukankecamatan.modalPilihKelurahan')
...
@include('pembentukankecamatan.uploadraperda_js')
@include('pembentukankecamatan.telaahan_js')
@include('pembentukankecamatan.permohonankode_js')
@include('pembentukankecamatan.rekomendasigubernur_js')
@include('pembentukankecamatan.kirimkekemendagri_js')
@include('pembentukankecamatan.skkemendagri_js')
