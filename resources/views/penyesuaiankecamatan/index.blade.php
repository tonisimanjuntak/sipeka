        ...
        <div class="col-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">LIST DATA PEMBENTUKAN KECAMATAN</h6>
                    @if (session('akseslevel') == 'Operator Kabupaten')
                    <a href="{{ url('pembentukankecamatan/tambah') }}" class="btn btn-sm btn-primary"><i
...
<script>
    ...
    $(document).ready(function() {
        table = $('#tableIndex').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ url('pembentukankecamatan/listindex') }}",
                type: 'GET',
                data: function(d) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.success) {
                                ...
                                .then(() => {
                                    window.location.href = "{{ url('pembentukankecamatan') }}";
                                });
                            } else {
