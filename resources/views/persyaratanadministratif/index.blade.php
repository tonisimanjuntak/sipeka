...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">PERSYARATAN ADMNISTRATIF</h1>
    </div>
        ...
        <div class="col-12">
            <div class="card shadow mb-4">
                ...
                <div
                    ...
                    <h6 class="m-0 font-weight-bold text-primary">LIST DATA PERSYARATAN ADMNISTRATIF</h6>
                    <a href="{{ url('persyaratanadministratif/tambah') }}" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    <div class="row">
...
<script>
    ...
    $(document).ready(function() {
        table = $('#tableIndex').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ url('persyaratanadministratif/listindex') }}",
                type: 'GET',
                data: function(d) {
            ...
            columns: [{
                ...
                },
                {
                    ...
                    name: 'idpersyaratanadministratif',
                    className: 'dt-body-center',
                    orderable: true,
                },
                {
                    data: 'namapersyaratanadministratif',
                    name: 'namapersyaratanadministratif',
