        ...
        <div class="col-12">
            <div class="card shadow mb-4">
                ...
                <div
                    ...
                    <a href="{{ url('pembentukankecamatan/tambah') }}" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-12 mb-3">
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="statusFilter" id="onprogress" value="Onprogress">
                                        <label class="form-check-label" for="onprogress">On Progress</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="statusFilter" id="selesai" value="Selesai">
