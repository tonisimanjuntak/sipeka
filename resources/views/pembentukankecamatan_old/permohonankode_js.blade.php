<script>
    $(document).ready(function () {
        ...
        $('#formPermohonanKode').bootstrapValidator({
            feedbackIcons: {
            ...
            fields: {
                nopermohonankode: {
                    validators: {
                        notEmpty: {
                            message: 'Nomor permohonan tidak boleh kosong'
                        }
                    }
                },
                tglpermohonankode: {
                ...
                filepermohonankode: {
                    validators: {
                        notEmpty: {
                            message: 'File permohonan tidak boleh kosong'
                        }
                    }
                },   
            }
        ...
        .on('success.form.bv', function(e) {
            ...
            // Kirim via AJAX
            $.ajax({
                url: "{{ url('pembentukankecamatan/simpanPermohonanKode') }}",
                type: 'POST',
                data: formData,
                contentType: false,
                processData: false,
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token-permohonankode"]').attr('content')
                },
