        ...
        <div class="col-12">
            <div class="card shadow mb-4">
                ...
                <div
                    ...
                    <h6 class="m-0 font-weight-bold text-primary">LIST DATA PENGGUNA</h6>
                    <a href="{{ url('pengguna/tambah') }}" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    <div class="row">
