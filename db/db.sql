...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_pembentukankelurahanterpilih` AS select `pembentukankelurahanterpilih`.`kelurahanterpilihid` AS `kelurahanterpilihid`,`pembentukankelurahanterpilih`.`nopengajuan` AS `nopengajuan`,`pembentukankelurahanterpilih`.`kodekelurahan` AS `kodekelurahan`,`pembentukankelurahanterpilih`.`jumlahpenduduk` AS `jumlahpenduduk`,`pembentukankelurahanterpilih`.`jumlahpendudukminimal` AS `jumlahpendudukminimal`,`pembentukankelurahanterpilih`.`jumlahkk` AS `jumlahkk`,`pembentukankelurahanterpilih`.`jumlahkkminimal` AS `jumlahkkminimal`,`pembentukankelurahanterpilih`.`luaswilayah` AS `luaswilayah`,`pembentukankelurahanterpilih`.`luaswilayahminimal` AS `luaswilayahminimal`,`kelurahan`.`namakelurahan` AS `namakelurahan`,`kelurahan`.`kodekecamatan` AS `kodekecamatan` from (`pembentukankelurahanterpilih` join `kelurahan` on((`pembentukankelurahanterpilih`.`kodekelurahan` = `kelurahan`.`kodekelurahan`))) */;
