...
CREATE TABLE `penataan` (
  ...
  `jenispenataan` enum('pembentukan','penggabungan','penyesuaian') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
insert  into `penataan`(`nopengajuan`,`tglpengajuan`,`idpengguna`,`deskripsi`,`inserted_date`,`updated_date`,`idstatuspengajuanterakhir`,`kodekecamatan`,`filesuratpengantar`,`tglverifikasipropinsi`,`nomorraperda`,`tglraperda`,`fileraperda`,`nomorregister`,`tglregister`,`filetelaahanhukum`,`filetelaahanteknis`,`nopermohonankode`,`tglpermohonankode`,`filepermohonankode`,`norekomendasigubernur`,`tglrekomendasigubernur`,`filerekomendasigubernur`,`tglkirimsuratkekemendagri`,`nomorskkemendagri`,`tglskkemendagri`,`fileskkemendagri`,`jenispenataan`) values ('0001/PB/2025','2025-09-23','DRDA28',NULL,'2025-09-23 11:03:09','2025-09-23 11:03:09','030','610105','ukomsertifikat_guru_pertama_2884893124550022106173.pdf','2025-09-23','123/ranperda','2025-09-23','ukomsertifikat_guru_pertama_2884893124550022106174.pdf','123','2025-09-23','ukomsertifikat_guru_pertama_2884893124550022106175.pdf','ukomsertifikat_guru_pertama_2888223118507022902464.pdf','1212','2025-09-23','ukomsertifikat_guru_pertama_2884893124550022106176.pdf','121212','2025-09-23','ukomsertifikat_guru_pertama_2884893124550022106177.pdf','2025-09-23','1212','2025-09-23','ukomsertifikat_guru_pertama_2888223118507022902465.pdf','pembentukan');
...
insert  into `penataankelurahanterpilih`(`kelurahanterpilihid`,`nopengajuan`,`kodekelurahan`,`jumlahpenduduk`,`jumlahpendudukminimal`,`jumlahkk`,`jumlahkkminimal`,`luaswilayah`,`luaswilayahminimal`) values (40,'0001/PB/2025','6101051001',10,1500,10,300,10.00,12.50),(41,'0001/PB/2025','6101051002',10,1500,10,300,10.00,12.50),(42,'0001/PB/2025','6101051003',10,1500,10,300,10.00,12.50);
...
insert  into `penataanpersyaratanadministratif`(`idpersyaratan`,`nopengajuan`,`filesuratkesepakatan`) values (19,'0001/PB/2025','ukomsertifikat_guru_pertama_2024_3073984135582022903086.pdf');
...
insert  into `penataanpersyaratandasar`(`idpersyaratan`,`nopengajuan`,`jumlahkelurahan`,`jumlahkelurahanminimal`,`filepersyaratan`) values (20,'0001/PB/2025',3,10,'ukomsertifikat_guru_pertama_2024_3073984135582022903085.pdf');
...
insert  into `penataanpersyaratanteknis`(`idpersyaratan`,`nopengajuan`,`filekemampuankeuangan`,`filesaranadanprasarana`,`bataswilayah`,`lokasicalonibukota`,`namakecamatan`,`kesesuaiantataruang`,`perbupbataswilayah`) values (19,'0001/PB/2025','ukomsertifikat_guru_pertama_2024_3073684156512022003782.pdf','ukomsertifikat_guru_pertama_2883163196582022800193.pdf','ukomsertifikat_guru_pertama_2888223118507022902463.pdf','ukomsertifikat_guru_pertama_2882383187546022904713.pdf','Test','ukomsertifikat_guru_pengawas_2852543110577022303952.pdf','ukomsertifikat_guru_pertama_2024_3078044131514022206055.pdf');
...
insert  into `penataanriwayat`(`idriwayat`,`nopengajuan`,`idstatuspengajuan`,`tglstatuspengajuan`,`deskripsi`,`idstatuspengajuannext`,`statusapprove`,`idpengguna`,`inserted_date`) values ('0001/PB/2025/001','0001/PB/2025','001','2025-09-23','','003',1,'DRDA28','2025-09-23 11:03:09'),('0001/PB/2025/002','0001/PB/2025','003','2025-09-23',NULL,'005',1,'KM5JZ0','2025-09-23 11:24:20'),('0001/PB/2025/003','0001/PB/2025','005','2025-09-23',NULL,'010',1,'DRDA28','2025-09-23 11:24:38'),('0001/PB/2025/004','0001/PB/2025','010','2025-09-23',NULL,'015',1,'KM5JZ0','2025-09-23 11:24:58'),('0001/PB/2025/005','0001/PB/2025','015','2025-09-23',NULL,'020',1,'DRDA28','2025-09-23 11:25:10'),('0001/PB/2025/006','0001/PB/2025','020','2025-09-23',NULL,'025',1,'KM5JZ0','2025-09-23 11:25:27'),('0001/PB/2025/007','0001/PB/2025','025','2025-09-23',NULL,'030',1,'KM5JZ0','2025-09-23 11:25:40'),('0001/PB/2025/008','0001/PB/2025','030','2025-09-23',NULL,'999',1,'KM5JZ0','2025-09-23 11:25:59');
...
insert  into `pengguna`(`idpengguna`,`kodekabupaten`,`nip`,`namalengkap`,`gelardepan`,`gelarbelakang`,`idpangkat`,`jabatan`,`nomorwa`,`email`,`username`,`password`,`nomorsk`,`tglsk`,`filesk`,`inserted_date`,`updated_date`,`lastlogin`,`foto`,`statusaktif`,`akseslevel`) values ('DRDA28','6101','893290392093029030','Budi',NULL,'ST','301','Pranata Komputer','0812000000000','budi@gmail.com',NULL,'$2y$12$xRo.djbF3X.JUUrBw/v4T.U2wpioRAehKNbiAasq.fPciuoaWeXuC','Budi123','2025-09-21','1.pdf','2025-09-21 18:06:44','2025-09-21 18:06:44','2025-09-23 09:25:01',NULL,'Aktif','Operator Kabupaten'),('KM5JZ0',NULL,'000000000000000000','Admin',NULL,NULL,'301','Pranata Komputer','081200000000','admin@gmail.com',NULL,'$2y$12$l/qBi3COmaEoxTbtkF9d/u4HC7FAulEh3Huy2zZsGoVkwqSuMdB/m','3243242','1999-01-01','surat_perjanjian_sewa_bangunan.pdf','2025-09-15 22:14:42','2025-09-21 21:51:06','2025-09-23 15:01:39',NULL,'Aktif','Admin');
...
insert  into `sessions`(`id`,`user_id`,`ip_address`,`user_agent`,`payload`,`last_activity`) values ('I7rU5RKebu8r2U522ix99y5WsQ7szDY82mf9T5B0',NULL,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36 Edg/140.0.0.0','',1758601561),('WiynHchdu7WrfkR4jZy3Fk4MvL9xbRwP4LCXNRjr',NULL,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36','',1758604568),('Xom8aTzD4wByHadpzKuFXgU6Pi2naG1Yjziiguk7',NULL,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36','',1758614505);
...
/* Function  structure for function  `createStatusPenataan` */

/*!50003 DROP FUNCTION IF EXISTS `createStatusPenataan` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `createStatusPenataan`(varidstatusterakhir CHAR(3)) RETURNS char(3) CHARSET utf8mb4 COLLATE utf8mb4_general_ci
BEGIN
...
/* Function  structure for function  `create_nopengajuan_penataan` */

/*!50003 DROP FUNCTION IF EXISTS `create_nopengajuan_penataan` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `create_nopengajuan_penataan`() RETURNS char(12) CHARSET utf8mb4 COLLATE utf8mb4_general_ci
    READS SQL DATA
BEGIN
...
/* Function  structure for function  `create_noriwayat_penataan` */

/*!50003 DROP FUNCTION IF EXISTS `create_noriwayat_penataan` */;
DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `create_noriwayat_penataan`(nopengajuan CHAR(12)) RETURNS char(16) CHARSET utf8mb4 COLLATE utf8mb4_general_ci
    READS SQL DATA
BEGIN
...
/*Table structure for table `v_penataan` */

DROP TABLE IF EXISTS `v_penataan`;

/*!50001 DROP VIEW IF EXISTS `v_penataan` */;
/*!50001 DROP TABLE IF EXISTS `v_penataan` */;

/*!50001 CREATE TABLE  `v_penataan`(
 `nopengajuan` char(12) ,
 `tglpengajuan` date ,
 `idpengguna` char(6) ,
 `deskripsi` text ,
 ...
 `jenispenataan` enum('pembentukan','penggabungan','penyesuaian') ,
 `namakecamatan` varchar(100) ,
...
/*Table structure for table `v_penataan_alljoin` */

DROP TABLE IF EXISTS `v_penataan_alljoin`;

/*!50001 DROP VIEW IF EXISTS `v_penataan_alljoin` */;
/*!50001 DROP TABLE IF EXISTS `v_penataan_alljoin` */;

/*!50001 CREATE TABLE  `v_penataan_alljoin`(
 `nopengajuan` char(12) ,
 `tglpengajuan` date ,
 `idpengguna` char(6) ,
 `deskripsi` text ,
...
/*Table structure for table `v_penataankelurahanterpilih` */

DROP TABLE IF EXISTS `v_penataankelurahanterpilih`;

/*!50001 DROP VIEW IF EXISTS `v_penataankelurahanterpilih` */;
/*!50001 DROP TABLE IF EXISTS `v_penataankelurahanterpilih` */;

/*!50001 CREATE TABLE  `v_penataankelurahanterpilih`(
 ...
 `jumlahkk` int ,
 `jumlahkkminimal` int ,
 `luaswilayah` decimal(18,2) ,
 `luaswilayahminimal` decimal(18,2) ,
 `namakelurahan` varchar(100) ,
 `kodekecamatan` char(8) 
)*/;
...
/*View structure for view v_penataan */

/*!50001 DROP TABLE IF EXISTS `v_penataan` */;
/*!50001 DROP VIEW IF EXISTS `v_penataan` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_penataan` AS select `penataan`.`nopengajuan` AS `nopengajuan`,`penataan`.`tglpengajuan` AS `tglpengajuan`,`penataan`.`idpengguna` AS `idpengguna`,`penataan`.`deskripsi` AS `deskripsi`,`penataan`.`inserted_date` AS `inserted_date`,`penataan`.`updated_date` AS `updated_date`,`penataan`.`idstatuspengajuanterakhir` AS `idstatuspengajuanterakhir`,`penataan`.`kodekecamatan` AS `kodekecamatan`,`penataan`.`filesuratpengantar` AS `filesuratpengantar`,`penataan`.`tglverifikasipropinsi` AS `tglverifikasipropinsi`,`penataan`.`nomorraperda` AS `nomorraperda`,`penataan`.`tglraperda` AS `tglraperda`,`penataan`.`fileraperda` AS `fileraperda`,`penataan`.`nomorregister` AS `nomorregister`,`penataan`.`tglregister` AS `tglregister`,`penataan`.`filetelaahanhukum` AS `filetelaahanhukum`,`penataan`.`filetelaahanteknis` AS `filetelaahanteknis`,`penataan`.`nopermohonankode` AS `nopermohonankode`,`penataan`.`tglpermohonankode` AS `tglpermohonankode`,`penataan`.`filepermohonankode` AS `filepermohonankode`,`penataan`.`norekomendasigubernur` AS `norekomendasigubernur`,`penataan`.`tglrekomendasigubernur` AS `tglrekomendasigubernur`,`penataan`.`filerekomendasigubernur` AS `filerekomendasigubernur`,`penataan`.`tglkirimsuratkekemendagri` AS `tglkirimsuratkekemendagri`,`penataan`.`nomorskkemendagri` AS `nomorskkemendagri`,`penataan`.`tglskkemendagri` AS `tglskkemendagri`,`penataan`.`fileskkemendagri` AS `fileskkemendagri`,`penataan`.`jenispenataan` AS `jenispenataan`,`kecamatan`.`namakecamatan` AS `namakecamatan`,`pengguna`.`namalengkap` AS `namalengkap`,`pengguna`.`gelardepan` AS `gelardepan`,`pengguna`.`gelarbelakang` AS `gelarbelakang`,`pengguna`.`kodekabupaten` AS `kodekabupaten`,`kabupaten`.`namakabupaten` AS `namakabupaten`,`statuspengajuan`.`namastatuspengajuan` AS `namastatuspengajuan`,`statuspengajuan`.`namastatuspengajuannext` AS `namastatuspengajuannext` from ((((`penataan` left join `pengguna` on((`penataan`.`idpengguna` = `pengguna`.`idpengguna`))) join `kecamatan` on((`penataan`.`kodekecamatan` = `kecamatan`.`kodekecamatan`))) left join `statuspengajuan` on((`penataan`.`idstatuspengajuanterakhir` = `statuspengajuan`.`idstatuspengajuan`))) left join `kabupaten` on((`pengguna`.`kodekabupaten` = `kabupaten`.`kodekabupaten`))) */;

/*View structure for view v_penataan_alljoin */

/*!50001 DROP TABLE IF EXISTS `v_penataan_alljoin` */;
/*!50001 DROP VIEW IF EXISTS `v_penataan_alljoin` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_penataan_alljoin` AS select `penataan`.`nopengajuan` AS `nopengajuan`,`penataan`.`tglpengajuan` AS `tglpengajuan`,`penataan`.`idpengguna` AS `idpengguna`,`penataan`.`deskripsi` AS `deskripsi`,`penataan`.`inserted_date` AS `inserted_date`,`penataan`.`updated_date` AS `updated_date`,`penataan`.`idstatuspengajuanterakhir` AS `idstatuspengajuanterakhir`,`penataan`.`kodekecamatan` AS `kodekecamatan`,`penataan`.`filesuratpengantar` AS `filesuratpengantar`,`penataan`.`tglverifikasipropinsi` AS `tglverifikasipropinsi`,`penataan`.`nomorraperda` AS `nomorraperda`,`penataan`.`tglraperda` AS `tglraperda`,`penataan`.`fileraperda` AS `fileraperda`,`penataan`.`nomorregister` AS `nomorregister`,`penataan`.`tglregister` AS `tglregister`,`penataan`.`filetelaahanhukum` AS `filetelaahanhukum`,`penataan`.`filetelaahanteknis` AS `filetelaahanteknis`,`penataan`.`nopermohonankode` AS `nopermohonankode`,`penataan`.`tglpermohonankode` AS `tglpermohonankode`,`penataan`.`filepermohonankode` AS `filepermohonankode`,`penataan`.`norekomendasigubernur` AS `norekomendasigubernur`,`penataan`.`tglrekomendasigubernur` AS `tglrekomendasigubernur`,`penataan`.`filerekomendasigubernur` AS `filerekomendasigubernur`,`penataan`.`tglkirimsuratkekemendagri` AS `tglkirimsuratkekemendagri`,`penataan`.`nomorskkemendagri` AS `nomorskkemendagri`,`penataan`.`tglskkemendagri` AS `tglskkemendagri`,`penataan`.`fileskkemendagri` AS `fileskkemendagri`,`penataan`.`jenispenataan` AS `jenispenataan`,`kecamatan`.`namakecamatan` AS `namakecamatan`,`kecamatan`.`tglberdiri` AS `tglberdiri`,`statuspengajuan`.`namastatuspengajuan` AS `namastatuspengajuan`,`statuspengajuan`.`namastatuspengajuannext` AS `namastatuspengajuannext`,`pengguna`.`nip` AS `nip`,`pengguna`.`namalengkap` AS `namalengkap`,`pengguna`.`gelardepan` AS `gelardepan`,`pengguna`.`gelarbelakang` AS `gelarbelakang`,`pengguna`.`kodekabupaten` AS `kodekabupaten`,`kabupaten`.`namakabupaten` AS `namakabupaten`,`penataanpersyaratanteknis`.`filekemampuankeuangan` AS `filekemampuankeuangan`,`penataanpersyaratanteknis`.`filesaranadanprasarana` AS `filesaranadanprasarana`,`penataanpersyaratanteknis`.`bataswilayah` AS `bataswilayah`,`penataanpersyaratanteknis`.`lokasicalonibukota` AS `lokasicalonibukota`,`penataanpersyaratanteknis`.`namakecamatan` AS `namakecamatanbaru`,`penataanpersyaratanteknis`.`kesesuaiantataruang` AS `kesesuaiantataruang`,`penataanpersyaratanteknis`.`perbupbataswilayah` AS `perbupbataswilayah`,`penataanpersyaratanadministratif`.`filesuratkesepakatan` AS `filesuratkesepakatan`,`penataanpersyaratandasar`.`jumlahkelurahan` AS `jumlahkelurahan`,`penataanpersyaratandasar`.`jumlahkelurahanminimal` AS `jumlahkelurahanminimal`,`penataanpersyaratandasar`.`filepersyaratan` AS `filepersyaratan` from (((((`penataanpersyaratanteknis` left join (`penataanpersyaratanadministratif` left join (`penataan` left join `penataanpersyaratandasar` on((`penataanpersyaratandasar`.`nopengajuan` = `penataan`.`nopengajuan`))) on((`penataanpersyaratanadministratif`.`nopengajuan` = `penataan`.`nopengajuan`))) on((`penataanpersyaratanteknis`.`nopengajuan` = `penataan`.`nopengajuan`))) left join `pengguna` on((`penataan`.`idpengguna` = `pengguna`.`idpengguna`))) left join `statuspengajuan` on((`penataan`.`idstatuspengajuanterakhir` = `statuspengajuan`.`idstatuspengajuan`))) left join `kecamatan` on((`penataan`.`kodekecamatan` = `kecamatan`.`kodekecamatan`))) left join `kabupaten` on((`pengguna`.`kodekabupaten` = `kabupaten`.`kodekabupaten`))) */;

/*View structure for view v_penataankelurahanterpilih */

/*!50001 DROP TABLE IF EXISTS `v_penataankelurahanterpilih` */;
/*!50001 DROP VIEW IF EXISTS `v_penataankelurahanterpilih` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_penataankelurahanterpilih` AS select `penataankelurahanterpilih`.`kelurahanterpilihid` AS `kelurahanterpilihid`,`penataankelurahanterpilih`.`nopengajuan` AS `nopengajuan`,`penataankelurahanterpilih`.`kodekelurahan` AS `kodekelurahan`,`penataankelurahanterpilih`.`jumlahpenduduk` AS `jumlahpenduduk`,`penataankelurahanterpilih`.`jumlahpendudukminimal` AS `jumlahpendudukminimal`,`penataankelurahanterpilih`.`jumlahkk` AS `jumlahkk`,`penataankelurahanterpilih`.`jumlahkkminimal` AS `jumlahkkminimal`,`penataankelurahanterpilih`.`luaswilayah` AS `luaswilayah`,`penataankelurahanterpilih`.`luaswilayahminimal` AS `luaswilayahminimal`,`kelurahan`.`namakelurahan` AS `namakelurahan`,`kelurahan`.`kodekecamatan` AS `kodekecamatan` from (`penataankelurahanterpilih` join `kelurahan` on((`penataankelurahanterpilih`.`kodekelurahan` = `kelurahan`.`kodekelurahan`))) */;
