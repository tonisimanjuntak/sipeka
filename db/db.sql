...
CREATE TABLE `pengajuan` (
  ...
  `jenispengajuan` enum('Pembentukan Kecamatan','Penggabungan  Kecamatan','Penyesuaian  Kecamatan') COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `pengajuanriwayat` (
  ...
  `idpengajuan` char(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `idstatuspengajuan` char(3) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tglstatuspengajuan` datetime DEFAULT NULL,
  `deskripsi` text COLLATE utf8mb4_general_ci,
  `idstatuspengajuannext` char(3) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `pengguna` (
  ...
  `statusaktif` enum('Aktif','Tidak Aktif') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'Aktif',
  `akseslevel` enum('Admin','Operator Kabupaten') COLLATE utf8mb4_general_ci DEFAULT 'Operator Kabupaten',
...
insert  into `persyaratandasar`(`idpersyaratandasar`,`namapersyaratandasar`,`batasminimalkabupaten`,`batasminimalkota`,`inserted_date`,`updated_date`,`idpengguna`,`statusaktif`) values ('001','Jumlah Penduduk',100,400,'2025-09-17 13:04:43','2025-09-17 13:04:43','KM5JZ0','Aktif');
...
insert  into `sessions`(`id`,`user_id`,`ip_address`,`user_agent`,`payload`,`last_activity`) values ('6WZ6rAt5e2xCN0fE9E8WcQAnUTXIVBCd0aOYQekP',NULL,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36','',1758095744);
...
CREATE TABLE `statuspengajuan` (
  `idstatuspengajuan` char(3) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `namastatuspengajuannext` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
