...
CREATE TABLE `pembentukankecamatan` (
  ...
  `idstatuspengajuanterakhir` char(3) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `pembentukanriwayat` (
  `idriwayat` char(16) COLLATE utf8mb4_general_ci NOT NULL,
...
insert  into `persyaratandasar`(`idpersyaratandasar`,`namapersyaratandasar`,`batasminimalkabupaten`,`batasminimalkota`,`inserted_date`,`updated_date`,`idpengguna`,`statusaktif`) values ('001','Jumlah Penduduk',100,400,'2025-09-17 23:30:09','2025-09-17 23:30:09','KM5JZ0','Aktif');
...
insert  into `sessions`(`id`,`user_id`,`ip_address`,`user_agent`,`payload`,`last_activity`) values ('YHbzL4HOTguXEPWQQSAAdt7g4XjCZ6WuzLqy0FGa',NULL,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36','',1758126667);
