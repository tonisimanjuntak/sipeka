...
use App\Models\Lappenggabungan;
use Illuminate\Http\Request;
use App\Models\Pengguna;
use TCPDF;

class LappenggabunganController extends Controller
{
    var $model;

    public function __construct()
    {
        $this->model = new Lappenggabungan();
        $this->isLogin();
    }

    public function index()
    {
        $data['menu'] = 'lappenggabungan';
        return view('lappenggabungan.indextemp', $data);
    }
    ...
    public function cetak($jenisCetakan, $tglawal, $tglakhir)
    {
        ...
        */
        ...
        $view = view('lappenggabungan.cetak', $data)->render();
