...
use App\Models\Lappembentukan;
use Illuminate\Http\Request;
use App\Models\Pengguna;
use TCPDF;

class LappembentukanController extends Controller
{
    var $model;

    public function __construct()
    {
        $this->model = new Lappembentukan();
        $this->isLogin();
    }

    public function index()
    {
        $data['menu'] = 'lappembentukan';
        return view('lappembentukan.index', $data);
    }
    ...
    public function cetak($jenisCetakan, $tglawal, $tglakhir)
    {
        ...
        */
        ...
        $view = view('lappembentukan.cetak', $data)->render();
