...
class Pengguna extends Model
{
    ...
    public function updateData($data, $idpengguna)
    {
        try {
            ...
            DB::table('pengguna')
                ...
                ->update($data);
            $this->App->riwayatAktifitas($data, 'pengguna', 'updateDatapengguna');
    ...
    public function hapusData($idpengguna, $rspengguna)
    {
        try {
            ...
            $this->App->riwayatAktifitas($rspengguna, 'pengguna', 'hapusDatapengguna');
    ...
    {
        return DB::select("SELECT create_idpengguna() AS id")[0]->id;
    }
}
